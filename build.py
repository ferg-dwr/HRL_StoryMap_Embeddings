...
/* centered, and never wider than a comfortable measure even in a full-bleed iframe */
.entry{width:100%;max-width:620px;margin:0 auto;}
...
@media (max-width:480px){body{font-size:15px;padding:2px 10px 8px;}}
"""
