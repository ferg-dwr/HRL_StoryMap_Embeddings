...
CSS = """/* HRL vocabulary definitions — floating card, centered in its frame */
:root{
  --ink:#1B1B1B;
  --term:#1C5BC4;
  --muted:#5A5A5A;
...
.entry{
  ...
  padding:24px 26px;
  box-shadow:
    0 1px 2px rgba(16,32,56,.05),
    0 6px 18px rgba(16,32,56,.09);
}
...
.headline{margin:0 0 6px;font-size:16px;line-height:1.5;}
.def{margin:0;}
...
.index-sub{font-size:14px;color:var(--muted);margin:0 0 14px;}
...
@media (max-width:480px){
  ...
  .entry{padding:18px 18px;border-radius:12px;}
}
"""
