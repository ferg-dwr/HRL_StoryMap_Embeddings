...
**Last updated:** 2026-08-07 (merged)
...
and its tributaries."* Feather and Sacramento now both appear in this panel — aligned.

**⚠️ All four named rivers are Sacramento-side.** Yuba, Feather, American, Sacramento.
Panel 2 introduces the San Joaquin, and HRL includes San Joaquin tributaries (Tuolumne,
Merced, Stanislaus), but none are named anywhere in the story. Worth deciding whether one
belongs here — otherwise a reader could finish Chapter 1 thinking this is a Sacramento
Valley program.
...
**Three jobs — sponge, kitchen, nursery — are the spine of Chapter 1.**

**⚠️ Order changed.** Screen 3 pays these off as kitchen → sponge → nursery. Either
reorder Screen 3's panels to match, or reorder back here. The callback is weaker if the
sequence differs.

**⚠️ Tribal content was removed from this panel.** The Indigenous fishing and tule-harvest
sentence is gone. Three notes elsewhere in this file assumed it was present and have been
updated: Screen 8, the video reconciliation table (decision 5), and the cross-cutting
to-dos. Chapter 1 no longer touches cultural history, which restores the original reason
the production notes held Wade's tribal line.
...
- [ ] ~~Tribal sign-off on Panel 5~~ — *moot, Indigenous content removed from Panel 5*
- [ ] **Reconcile the three-jobs order** between Screen 1 Panel 5 and Screen 3
- [ ] Decide whether a San Joaquin tributary should be named in Panel 1
...
>
> The ocean can be more or less dangerous for young salmon at different times. If salmon spend different amounts of time growing in the Delta, they leave at different times and at different sizes. That spread in size and timing also shapes how many come home years later. Spreading the risk across many individuals keeps the whole group safer.
>
...
**Job:** make the infrastructure real, specific, and named.
...
### Panel 1 — The water doesn't arrive when we need it
- California's water shows up in winter and spring. We need it in summer and fall
- Most of the state's rain and snow land in the north. Most of the people and farms are elsewhere
- Two problems: wrong time, wrong place
- *Hook:* so we built our way around both

### Panel 2 — We built places to keep it
- **Reservoirs** hold water until later — Shasta, Oroville, Folsom, New Melones
- A dam is a savings account for water
- Scale: name the biggest, give one number a kid can hold onto
- These also do flood control — they catch the flood *and* save the water

### Panel 3 — We built ways to move it
- **Aqueducts** and canals carry water hundreds of miles
- Pumping plants in the south Delta lift it into those canals
- Water that fell as snow on the Sierra can end up in a faucet in Southern California
...
**This panel is the hinge for the whole chapter.** It's where "trade, not crime" pays
off, and it's what keeps water agencies reading.

**Media — DWR:** DWR's home turf; the imagery almost certainly exists. *If available* —
**Oroville Dam and spillway**, **Banks Pumping Plant**, **the California Aqueduct running
through farmland**, **a reservoir at low water**. Aerials preferred; scale is the point.
**Media — MAP:** infrastructure map — major reservoirs, aqueducts, pumping facilities,
with the watershed underneath.

### Screen 6 to-dos
- [ ] Draft copy from bullets
- [ ] Pick the one memorable scale number for Panel 2
- [ ] Vocabulary cards: **reservoir**, **aqueduct**, possibly **diversion**
- [ ] **Request from DWR:** infrastructure aerials
- [ ] Build infrastructure map
- [ ] Consider merging Panels 2–3 if the screen runs long
...
**Status:** ⬜ outlined, copy not drafted
**Job:** make the constraint honest and specific. This is what turns "we don't have to
choose" into a real claim rather than a slogan.

### Panel 1 — Who's asking
- Cities — drinking water for tens of millions
- Farms — food, and a lot of it
- Fish and the rivers themselves
- Flood protection
- Recreation, boating, fishing
- *All of these are legitimate. That's what makes it hard*

### Panel 2 — There isn't enough
- In most years, giving everyone everything they want is not possible
- Wet years and dry years are wildly different, and getting less predictable
- **Drought** is normal in California — part of the pattern, not a surprise

### Panel 3 — So somebody has to decide
- The state sets rules for how much water stays in rivers and how much can be taken out
- Those rules come from the Bay-Delta Water Quality Control Plan
- Written plainly: a rulebook for sharing
- **Keep this neutral.** Explain the mechanism, skip the politics
- *Check with program office on appropriate level of detail*

### Panel 4 — The old way of deciding
- Historically framed as a tug-of-war: more water for fish means less for people
- That framing makes every decision a fight somebody has to lose
- *Hinge into Screen 8:* the tug-of-war framing was never quite right, because salmon
  and people were never really on opposite sides
...
question. If Screen 7 states the tension honestly, his line lands as a resolution.

**Media — FIG-i:** *Strong interactive candidate.* Where the water goes — a flow or
allocation diagram the reader can explore, showing how it shifts between wet and dry
years. Static won't carry this; the whole point is that the answer changes.
**Media — DWR:** *If available* — paired images of the same reservoir in a wet year and
a drought year.

### Screen 7 to-dos
- [ ] Draft copy from bullets
- [ ] **Program office:** how much Bay-Delta Plan detail is appropriate?
- [ ] Decide whether "Bay-Delta Water Quality Control Plan" is sayable at this reading
      level, or becomes "the state's rulebook for sharing water" with the formal name
      in a caption
- [ ] Vocabulary cards: **drought**, **diversion**
- [ ] Build water allocation interactive (FIG-i)
- [ ] **Request from DWR:** reservoir wet year vs. drought year pair
...
**Format:** Sidecar (docked) · ~4 panels
**Status:** ⬜ **cannot be drafted without contributor input**
**Job:** the emotional turn.

**⚠️ Panel 1 is deliberately unwritten.** Drafting tribal content speculatively and then
asking for edits puts Anecita in the position of correcting rather than authoring, on
material that needs her sign-off anyway. Bullets below are placeholders for structure
only.
...
- People who live with this water every day
- Recreation and quality of life

### Panel 4 — The turn
- Healthy rivers make water supply *more* reliable — a system that works ecologically has
  fewer emergency shutoffs and fewer lawsuits
- Fewer crises means fewer sudden restrictions for everyone
- *Hinge:* which raises the obvious question — can we actually do both?

**Note:** Chapter 1's tribal reference has been removed, so this screen now **introduces**
the tribal thread rather than continuing it. That raises the stakes on Panel 1 — it is the
reader's first encounter with Indigenous relationships to salmon, and it arrives in
Chapter 2. Worth asking Anecita whether an earlier mention would serve better.
...
### Screen 8 to-dos
- [ ] **Meet with Anecita** — Panel 1 content, and sign-off scope across all three places
- [ ] **Meet with Mariko** — framing for the screen as a whole
- [ ] Draft Panels 2–4 once framing is settled
- [ ] Source fishing community imagery
- [ ] Confirm current salmon fishing closure status before publication
...
**Status:** ⬜ outlined, copy not drafted
**Job:** introduce HRL. Wording matches the Crowfoot video exactly, since that script is
finalized.

### Panel 1 — A different approach
- For decades, water and habitat were treated as separate problems
- Healthy Rivers and Landscapes treats them as one
- Built by state agencies, water agencies, and scientists working together — the people
  who used to argue about this
- *That collaboration is itself part of the news*
...
- The *Landscapes* half of the name
- Reconnecting rivers to their **floodplains** so shallow water can grow food again
- This is **restoration** — getting a place doing its old jobs
...
**🎬 Video placement — OPEN DECISION.** See Video Reconciliation below. If the video moves
to Screen 12, this screen carries the three ideas in text and hands off to Screen 10; if
it stays here, the closing 15 seconds need cutting.

### Screen 9 to-dos
- [ ] Draft copy from bullets
- [ ] **Lock the three-ideas wording** against the final video script
- [ ] Build HRL project boundary map
- [ ] Resolve video placement (affects panel count)

---

## Screen 10 · Where it's happening ⬜

**Format:** Map Tour — *the one exception to the all-Sidecar rule.*
**Status:** ⬜
**Job:** proof. Real places, real acreage, real construction.

### Stops
- **Prospect Island** (Solano County) — ~1,600 acres of wetland restoration
- **Lower Elkhorn Basin** (Yolo Bypass) — levees moved back, ~1,000 acres of new room
- **Tributary projects** — one or two, ideally rivers named back in Screen 1 Panel 1 so
  the reader recognizes them
- **The people of HRL** — last stop, or a short panel after
...
- One photo — construction or "water has come in" beats a rendering

**⚠️ Naming mismatch with the video.** Wade says *"In Solano County"* (= Prospect Island)
and *"along the Yolo Bypass, we moved levees back"* (= Lower Elkhorn Basin). A viewer who
hears counties and then sees project names has to do the matching. Cheapest fix: have
Wade name them. Then this screen is a payoff instead of a puzzle.
...
*These double as video b-roll — shoot once, use twice.*

### Screen 10 to-dos
- [ ] Choose which tributary projects to feature
- [ ] Confirm Prospect Island (1,600 ac) and Lower Elkhorn (1,000 ac) acreages
- [ ] **Request from DWR:** before/after and construction photos per site
- [ ] Write per-stop copy
- [ ] Gather photos and bios for "the people of HRL"
...
**Status:** ⬜ outlined, copy not drafted
**Job:** the credibility beat — the strongest argument for a CNRA audience.

### Panel 1 — We watch
- Counting fish, measuring water temperature and flow, tracking what grows on the floodplain
- Callback to Screen 4 Panel 2: same kind of work, now pointed forward
- People in waders, again

### Panel 2 — We measure
- Concrete example: at the Yolo Bypass project, food production went up — measurably
- *If any early results are cleared for release, an honest chart beats any description*
- The point isn't that it's working. The point is that we can tell

### Panel 3 — We change what we do
- If something doesn't help, the plan changes
- Written into how the program works, not an afterthought
- Tributaries share what they learn with each other
- *This is the state-of-the-art claim, stated plainly*
...
HRL Science Plan and cross-tributary collaboration — rather than restating the concept.
If it can't, fold it into Screen 9 and let Wade carry it.

**Avoid the term "adaptive management"** — say what it means instead. *(Wade's script does
the same.)*

**Media — DWR:** *If available* — **monitoring in action**: crews with nets, screw traps,
water quality sondes, tagging.
...
### Screen 11 to-dos
- [ ] **Are any early monitoring results cleared for public release?**
- [ ] Decide: does this survive as its own screen, or fold into Screen 9?
- [ ] Get HRL Science Plan detail for Panel 3
- [ ] **Request from DWR:** monitoring fieldwork imagery
- [ ] Draft copy from bullets
...
### Panel 1 — This takes time
- Restoration works on the timescale of salmon generations, not budget cycles
- A floodplain reconnected this year helps fish that return in three or four years
- Being honest about the timeline is more persuasive than promising quick wins

### Panel 2 — What it could look like
- Picture the Delta in thirty years if this works
- Water still flowing to homes and farms
- More shallow water, more food, more young salmon reaching the ocean big enough to survive
- The three jobs, partly back at work

### Panel 3 — Close
- **🎬 Recommended home for the Crowfoot video** — the script's arc (loss, response,
  proof, invitation) is the whole StoryMap in miniature, and it already ends with
  "thank you for reading"
- Newsletter link — tappable, not only a QR code
- Sources and further reading in a footer, not as the ending

**Media — DWR:** a hopeful image — restored habitat with water on it, or people in the
field. End on something living.

### Screen 12 to-dos
- [ ] Resolve video placement
- [ ] Draft copy from bullets
- [ ] Build sources footer
- [ ] Confirm newsletter signup link
- [ ] **Request from DWR:** hopeful closing image

---

# Chapter 2 — structure notes

**The chapter's job, in order:**
1. Show why we can't just undo it — the infrastructure is real, it works, millions depend on it
2. Show that people and salmon aren't opponents
3. Show what HRL does about it, and how we'll know if it works

**The trap to avoid:** jumping from "here's the problem" to "here's our program." The
reader has to feel the constraint before the solution means anything. Screens 6 and 7
exist to make the constraint real.

**Panel count check**

| Screen | Panels | Note |
|---|---|---|
| 6 | 5 | At the upper limit — merge Panels 2–3 if it runs long |
| 7 | 4 | Good |
| 8 | 4 | Good |
| 9 | 4 | 5 if the video stays here |
| 10 | ~4 stops | Map Tour |
| 11 | 3 | Good |
| 12 | 2–3 | Good |

Chapter 2 totals ~26 panels against Chapter 1's ~25. Balanced.
...
| 5 | **Tribal line.** Held from the draft pending sign-off. Chapter 1's tribal reference has since been **removed** | (a) Add it back with sign-off · (b) Leave to Screen 8 | **(b) for now** — the original reason for holding it is back in force |
...
- ✅ Feather and Sacramento named in Screen 1 Panel 1, matching Wade's revised river list
...
- [ ] *Indigenous* — Screen 8 (removed from Screen 1). Check whether it needs a card
...
- [ ] **Tribal sign-off scope** — Screen 8 only now, since Chapter 1's reference was
      removed. Confirm with Anecita whether introducing the thread that late is right
- [ ] Decide embed vs. link vs. inline for each vocabulary term
- [ ] Vocabulary cards needed for Chapter 2: reservoir, aqueduct, drought, diversion
- [ ] Photo rights and attribution check on every non-DWR image# HRL StoryMap — Panel Content, Media & To-Dos
