# HRL StoryMap — Slide Content & To-Dos
...
- Sidecar layout: **docked**, not floating
- Every slide answers a question the previous slide made the reader ask
- No number lands before the reader has a reason to care about it

---

# CHAPTER 1 — California Delta

## Screen 1 · Sidecar: "Meet the watershed"

**Format:** Sidecar (docked) — text and map must move together.
...
*Media: statewide map, Sierra snowpack, tributaries lighting up as named.*
...
*Media: same map, zoom to confluence, watershed boundary shaded.*
...
*This panel closes the loop back to Panel 1 and plants salmon before Screen 3 needs them.*
...
**Three jobs — kitchen, sponge, nursery — are the spine of Chapter 1.** Screen 2 pays
off each one by name. (Originally four; "filter" was cut because nothing downstream
paid it off.)
...
- [ ] Source historic tule marsh illustration for Panel 3
- [ ] Pacific Flyway or food-web figure for Panel 4
- [ ] Custom 3-icon graphic for Panel 5 (kitchen / sponge / nursery)
- [ ] Decide: globe inset static PNG vs. interactive treatment
- [ ] Alt text for all media

---

## Screen 1b · Slideshow: Floodplain land-use change

**Format:** Slideshow — media is the star, text is caption-length.
**Status:** ✅ copy drafted · 🟡 media partial
**Note:** Sequence was reordered — swipe now comes *before* the numbers.
...
*Framing note: "trade, not crime" is what lets farmers and water agencies stay in the story through Chapter 3.*

### Slide 4 — The 2012 map ✅
...
- [ ] **Pick size comparison.** Rhode Island (~776,000 ac) is larger than the loss —
      either soften wording or find a California comparison that lands precisely
- [ ] Source historic photo for Slide 3 (dredging / levee construction era)
- [ ] Confirm SFEI attribution and permission for map use
- [ ] Confirm USGS 2012 dataset citation format
- [ ] Build swipe block with both layers
...
**Format:** Standalone blocks, 3 sections — deliberate breather after two immersive
blocks. The "why it matters to you" boxes work better as page content than inside a
narrow sidecar column.
**Status:** ✅ redrafted — needs review
**Structure:** three beats matching the three jobs from Panel 5. Practical stakes
("why it matters to you") are folded into each beat rather than sitting in a separate
economics section. The *human* relationship — tribal, historical, recreational — stays
on Screen 7.
...
### Beat 3 — The nursery emptied out
...
- [ ] Decide whether to name carbon/climate explicitly in Beat 2, or leave implicit
- [ ] Build kitchen figure (shallow floodplain food web vs. deep channel)
- [ ] Build sponge figure (before/after cross-section, land sinking below sea level)
- [ ] Build native fish vignettes
- [ ] Style the "Why it matters to you" boxes consistently across all three beats

## Screen 3 · Salmon in Decline

**Format:** Standalone — one graph with text around it. An immersive block adds nothing.
**Status:** ✅ drafted — numbers to be filled in
**Figure:** fall-run Chinook counts over time (GrandTab)

### Beat 1 — Why this fish
...
### Beat 2 — How do you count a fish?
...
who studies this, and Chapter 3's credibility rests on Chapter 1 being careful.*

### Screen 3 to-dos
- [ ] **Fill in years and counts** from GrandTab
- [ ] Resolve open question: fall run only, or all runs shown together?
- [ ] Finalize figure (`Chinook_Escapement_Figure.ipynb`) — confirm axis labels read at
      elementary level, no jargon in the legend
- [ ] Confirm the 1950s start date for California salmon counting
- [ ] Alt text for the figure
- [ ] Decide whether to name specific dams in Beat 5 or keep it general

---

## Screen 4 · The Salmon Lifecycle

**Format:** Sidecar (docked) — six stages with the map changing per stage. Exactly what
Sidecar is for.
**Status:** ✅ drafted · 🟡 map in progress
**Structural note:** sits at the end of Chapter 1 so watershed scope is established
before Chapter 2.
...
### Beat 2 — The journey *(pairs with the lifecycle map)*
...
### Beat 3 — Why the Delta matters so much
...
### Beat 4 — Where the journey breaks *(pending Scott's input)*
...
### Screen 4 to-dos
- [ ] **Ask Scott** about showing stressors spatially on the lifecycle figure
- [ ] Reference Figure 3 from the life-history diversity paper for lifecycle structure
- [ ] Build lifecycle map with per-stage highlighting for the sidecar
...
# CHAPTER 2 — Competing Demands for the Delta's Water

## Screen 5 · What happened? ⬜
Population growth, agricultural productivity, river engineering. Graphics needed.

## Screen 6 · Challenges in Restoring the Delta ⬜
Competing beneficial uses, Bay-Delta Water Quality Control Plan, state of the
science, limited resources, safety. Keep to complexity of competing demand — not
political conflict.

## Screen 7 · Salmon and People ⬜
**Now carries the cultural content moved from Screen 2:** economics, historical
significance, modern life. Needs input from Anecita Agustinez (tribal perspective)
and Mariko Falke (framing). This is the emotional turn — people and salmon are not
opposites.

---

# CHAPTER 3 — Healthy Rivers and Landscapes

## Screen 8 · The Plan ⬜
Expand to cover the HRL proposal itself: water, habitat, science.

## Screen 9 · HRL Projects ⬜
**Use a map tour here** — real sites, click-through. Plus "the people of HRL."

## Screen 9b · How do we know it's working? ⬜
**Proposed addition.** Monitoring and adaptive management. "We watch. We measure.
We change what we do." Strongest credibility beat for the CNRA audience.

## Screen 10 · Closing ⬜
Rework from "Want to Learn More?" into something forward-looking. Sources to footer.

---

# Block format plan

Immersive blocks (Sidecar, Slideshow, Map Tour) take over the viewport and control
pacing. Powerful, and tiring. Three in a row and readers feel handled. Standalone blocks
scroll normally and give room to breathe.

| Screen | Format | Why |
|---|---|---|
| 1 · Meet the watershed | Sidecar (docked) | Text and map must move together |
| 1b · Land-use change | Slideshow | Media is the star |
| 2 · Consequences | Standalone ×3 | Breather. "Why it matters" boxes need page width |
| 3 · Salmon decline | Standalone | One graph plus text |
| 4 · Lifecycle | Sidecar (docked) | Six stages, map changes per stage |
| 5-7 · Chapter 2 | Mostly standalone | Saves immersive capacity for Chapter 3 |
| 9 · HRL Projects | Map Tour | Real sites, click-through |

Resulting rhythm: immersive, immersive, breathe, breathe, immersive.
...
**Added for Screen 2:** marsh, peat, native, channel
**Added for Screens 3-4:** chinook, run, gravel

**Style sweep done:** "It's not X, it's Y" removed from wetland, estuary, restoration,
marsh, and floodplain cards, and from Panel 5, Slides 1-3, and Screen 2 Beats 1-2.

**Words used but not yet carded — decide card vs. rewrite:**
- [ ] *Yolo Bypass* — proper noun, explained inline. Probably fine as is
- [ ] *escapement* — avoided entirely on Screen 3. Keep it that way
- [ ] *smolt* — deliberately not used. "Young salmon" instead
- [ ] *adaptive management* — Chapter 3. Needs plain-language replacement, not a card.
      "We watch. We measure. We change what we do." already says it better
- [ ] *diversion* — will come up in Chapter 2
...
- [ ] Alt text for every figure and map (state accessibility requirement)
- [ ] Identify draft reviewers and data leads
- [ ] CNRA communications review of Crowfoot video script
